...
/*   Updated: 2023/09/22 17:49:45 by jmetezea         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_check_wall_NE(t_data *data)
{
	...
	i = 0;
	// x = (data->player_x - (int)data->first_y - ((int)data->delta_y * i)) / PXL;
	// x = (data->player_x - (int)data->first_y - ((int)data->delta_y * i)) / PXL;
	// ft_printf("XXXXX : %d\n", x);
	// i = 1;
	// x = (data->player_x - (int)data->first_y - ((int)data->delta_y * i)) / PXL;
	// ft_printf("XXXXX : %d\n", x);
	// y = ((int)data->delta_x * i + data->player_y + (int)data->first_x) / PXL;
	// ft_printf("Y : %d\n", y);
	// i = 1;
	// y = ((int)data->delta_x * i + data->player_y + (int)data->first_x) / PXL;
	// ft_printf("Y : %d\n", y);
	...
	// ft_printf("Y : %d\n", y);
	// i = 0;
	// x = (data->player_x % PXL) - 1;
	// y = ((data->player_y + data->first_x) % PXL) - 1;
	// if (data->map[x][y] == '1')
	// 	return ;
	while(1)
	{
		y = (data->player_y + (int)data->first_x + (int)data->delta_x * i) / PXL;
		x = (data->player_x / PXL) - 1 - i;
		if (y > 200)
		{
			data->dist_y = 100000;
			break;
		...
		ft_printf("X : %d\n", x); 
		ft_printf("Y : %d\n", y);
		if (data->map[x][(int)y] == '1')
		{
			data->dist_x = (data->first_x + (data->delta_x * i)) / cos(data->anglerad);
			break;
		}
		else
			i++;
	...
	{
		// x = (data->player_x - (int)data->first_y - ((int)data->delta_y * i)) / PXL;
		x = data->player_x - (int)data->first_y;
		y = (data->player_y / PXL) - 1 + i;
		ft_printf("Vertical\n");
		ft_printf("X : %d\n", x);
		ft_printf("Y : %d\n", y);
		if (x < 0)
		...
		if (data->map[x][y] == '1')
		{
			data->dist_y = (data->first_y + (data->delta_y * i)) / cos(data->anglerad);
			break;
		}
		else
			i++;
